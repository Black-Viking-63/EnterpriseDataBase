...
namespace AirBase.Classes.SQL
{
    public static class clsSQLDataQuery
    {
        ...
        public static string selectNameTable()
        {
            switch (clsManage.NumberTable)
            {
                case 0: return "activeAircraft"; 
                case 1: return "informationAircraft";
                case 2: return "airport"; 
                case 3: return "runway"; 
                case 4: return "aircompany"; 
                case 5: return "passenger"; 
                case 6: return "clientAircompany"; 
                default: return "";
            }
        }

        public static string deleteRowFromTableOneManyToOne(int id)
        {
            string queryDelete = "";
            switch (clsManage.NumberTable) 
            {
                case 0: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
                case 1: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
                case 2: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
                case 3: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
                case 4: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
                case 5: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
                case 6: queryDelete = "delete from " + selectNameTable() + " where id_" + selectNameTable() + " = " + id; break;
            }
